...
public class CalculationController {
	...
	public String toCalculation( Model model ) {
		model.addAttribute("message", "整数を入力して下さい。");
		model.addAttribute("calculationModel", new CalculationModel());
		return "calculation";
	}

	@RequestMapping(value = "/sample", method = RequestMethod.POST)
	public String calculate(@ModelAttribute CalculationModel calculationModel, Model model ) throws NegativeException {
